  ...
  class GameManager {
    constructor() {
      ...
      this.state = {
        ...
        upgrades: {},
        age: 'prehistoric', // Make sure this matches an era in data
        progress: 0,
        workers: {
    ...
    updateProgress(increment) {
      ...
      const progressionRequirements =
        data.progressionRequirements[this.currentEra];
     ...
     */
    getUpgradeById(id) {
      return data.eras[this.currentEra].upgrades.find(
